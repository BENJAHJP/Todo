...
import com.example.todo.presentation.add_edit.AddEditScreenEvents
import com.example.todo.presentation.add_edit.AddEditViewModel
...
fun AddEditScreen(
    ...
    Scaffold (
        floatingActionButton = {
            FloatingActionButton(
                onClick = {
                    viewModel.onEvent(AddEditScreenEvents.OnSubmit)
                }) {
